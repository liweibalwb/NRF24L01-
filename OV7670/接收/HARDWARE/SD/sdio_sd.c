...
*All rights reserved
***************************************************************
*硬件连接：SDIO_CMD------------PFD2	 SDIO_CK--------------PC12
		   SDIO_D0 ------------PC8	 SDIO_D1--------------PC9
		   SDIO_D2-------------PC10  SDIO_D3--------------PC11
...
SD_Error SD_GetCardInfo(SD_CardInfo *cardinfo)
{
  ...
  if ((CardType == SDIO_STD_CAPACITY_SD_CARD_V1_1) || (CardType == SDIO_STD_CAPACITY_SD_CARD_V2_0))
  {
    ...
    cardinfo->CardCapacity *= cardinfo->CardBlockSize;					//单位：BYTE
  }
  else if (CardType == SDIO_HIGH_CAPACITY_SD_CARD)
  {
    ...
    cardinfo->CardCapacity = (cardinfo->SD_csd.DeviceSize + 1) * 512 ; //单位：KB
